<section class="l-calendar u-bg-folk-primary my-5 py-5">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h2 class="l-here__title u-line-height-100 text-uppercase u-font-weight-semibold u-color-folk-white">
                            Agenda <br>
                            <span class="u-font-weight-black u-color-folk-white">Paroquial:</span>
                        </h2>
                    </div>
                </div>
            </div>
                        ...
                        ?>
                                    <div class="swiper-slide">
                                        ...
                                        <div class="col my-3 my-md-0">
                                            ...
                                            <div class="col-12 d-flex flex-wrap justify-content-center pl-0">
                                                <!-- loop -->
                                                <?php 
                                                ...
                                                ?>
                                                            <div class="col-md-10">
                                                                ...
                                                                <p class="l-calendar__text u-font-weight-extrabold u-color-folk-white">
                                                                    <span class="text-uppercase u-color-folk-white"><?php echo $data_day . ' de ' . get_long_month( $data_month ); ?></span> - <?php echo $agenda['title']; ?>
                                                                </p>
                                                            </div>     
                                                <?php 
                                                        else : $count++; 
