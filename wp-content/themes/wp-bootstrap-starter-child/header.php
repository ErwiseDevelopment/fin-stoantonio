...
<div id="page" class="site">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-11">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 d-flex d-lg-block justify-content-center align-items-center my-3 my-lg-0 px-lg-0">      
                            <?php if ( get_field( 'logo_no_topo', 'option') ) : ?>
    ...
    <header id="masthead" class="l-header header site-header navbar-static-top u-bg-folk-primary py-4 py-lg-0 <?php echo wp_bootstrap_starter_bg_class(); ?>" role="banner">
        ...
        <div class="container-fluid px-5">
            ...
            <nav class="l-navbar navbar navbar-expand-xl p-0">
                ...
                <div class="col-lg-5">
                    <?php
                        wp_nav_menu(array(
                            'theme_location'  => 'menu_esquerdo',
                            'container'       => 'div',
                            'container_id'    => 'main-nav',
                            'container_class' => 'collapse navbar-collapse justify-content-center py-4',
                            'menu_id'         => false,
                ...
                <div class="col-2 d-none d-lg-block">
                    ...
                    <div class="l-header__box-brand navbar-brand">
