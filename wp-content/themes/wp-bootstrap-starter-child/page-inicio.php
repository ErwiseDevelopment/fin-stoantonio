...
<!-- process -->
<?php echo get_template_part( 'template-parts/content', 'process' ); ?>
<!-- end process -->
...
<!-- patron -->
<?php echo get_template_part( 'template-parts/content', 'patron' ); ?>
<!-- end patron -->

<!-- news -->
<section class="l-news u-border-top-2 u-border-color-primary my-4 d-none">
...
<!-- digital -->
<section class="l-digital u-border-top-2 u-border-color-primary my-5 d-none">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h3 class="l-digital__title-secondary d-inline-flex u-font-weight-bold text-uppercase u-color-folk-white u-bg-folk-primary py-3 px-5">
                            <span class="u-font-weight-medium u-color-folk-white mr-2">//</span> siba mais
                        </h3>
